...
> You might encounter an issue when installing Breeze. Upon installation, it will delete the routes in the navigation file and it will appear in the stage. ![stage1](/Glossary-API/public/img/stage1.png).
...
> Alternatively, simply discard all changes and leave only the `composer.lock`. ![stage2](/Glossary-API/public/img/stage2.png).
